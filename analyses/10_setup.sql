/*
Purpose:
    We create the objects needed for dbt Snowflake FinServ Asset Management Demo
...
//Create role
    ...
    create warehouse if not exists finservam_devops_wh
        with warehouse_size = 'xsmall' auto_suspend = 1 initially_suspended = true comment = 'Financial Services DevOps Compute';
    create warehouse if not exists finservam_datascience_wh
        with warehouse_size = 'xsmall' auto_suspend = 1 initially_suspended = true comment = 'DataScience will often scale to extremes';
